...
VALUES
    ...
    (true, 10500, now(), null, now(), 'd2ed72d8-090a-4efb-abe4-7acbdce120e2'::uuid, null, 'd2ed72d8-090a-4efb-abe4-7acbdce120e2'::uuid, '3fa85f64-5717-4562-b3fc-2c963f66afa6'::uuid, '439f222b-0cbb-4600-a989-e7fdabf120d7'::uuid, '겉바속촉 고등어 구이와 푸짐한 파스타 곁들임!  참김에 싸먹는 별미 정식.  스파르타파스타만의 특별한 조합', '고등어 구이 정식', '고등어_사진.jpg'),
    (true, 10500, now(), null, now(), 'd2ed72d8-090a-4efb-abe4-7acbdce120e2'::uuid, null, 'd2ed72d8-090a-4efb-abe4-7acbdce120e2'::uuid, '3fa85f64-5717-4562-b3fc-2c963f66afa6'::uuid, '439f222b-0cbb-4600-a989-e7fdabf120d8'::uuid, '여수산 갓김치의 톡 쏘는 매콤함과 쫄깃한 면발의 환상적인 만남!  스파르타파스타만의 특별한 비빔국수','킹갓제너럴 비빔국수', '갓비빔국수.jpg'),
    (true, 12000, now(), null, now(), 'e3f1a2b4-7d33-4c8e-ae72-9f5dbe7621a3'::uuid, null, 'e3f1a2b4-7d33-4c8e-ae72-9f5dbe7621a3'::uuid, '3fa85f64-5717-4562-b3fc-2c963f66afa6'::uuid, 'a1b2c3d4-5678-90ab-cdef-1234567890aa'::uuid, '바삭한 튀김과 달콤 짭조름한 돈가츠 소스의 조화! 정통 일본식 돈가츠 정식', '일본식 돈가츠 정식', '돈가츠.jpg'),
    (true, 15000, now(), null, now(), 'e3f1a2b4-7d33-4c8e-ae72-9f5dbe7621a3'::uuid, null, 'e3f1a2b4-7d33-4c8e-ae72-9f5dbe7621a3'::uuid, '3fa85f64-5717-4562-b3fc-2c963f66afa6'::uuid, 'a1b2c3d4-5678-90ab-cdef-1234567890bb'::uuid, '진한 돈코츠 육수와 쫄깃한 면발이 조화를 이루는 일본 정통 라멘', '돈코츠 라멘', '돈코츠라멘.jpg'),
    (true, 13000, now(), null, now(), 'e3f1a2b4-7d33-4c8e-ae72-9f5dbe7621a3'::uuid, null, 'e3f1a2b4-7d33-4c8e-ae72-9f5dbe7621a3'::uuid, '3fa85f64-5717-4562-b3fc-2c963f66afa6'::uuid, 'a1b2c3d4-5678-90ab-cdef-1234567890cc'::uuid, '신선한 해산물이 듬뿍 들어간 일본 전통 해산물 덮밥', '카이센동', '카이센동.jpg'),
    (true, 11000, now(), null, now(), 'e3f1a2b4-7d33-4c8e-ae72-9f5dbe7621a3'::uuid, null, 'e3f1a2b4-7d33-4c8e-ae72-9f5dbe7621a3'::uuid, '3fa85f64-5717-4562-b3fc-2c963f66afa6'::uuid, 'a1b2c3d4-5678-90ab-cdef-1234567890dd'::uuid, '부드럽고 진한 달걀 소스가 매력적인 일본식 오믈렛 덮밥', '오야코동', '오야코동.jpg'),
    (true, 12500, now(), null, now(), 'e3f1a2b4-7d33-4c8e-ae72-9f5dbe7621a3'::uuid, null, 'e3f1a2b4-7d33-4c8e-ae72-9f5dbe7621a3'::uuid, '3fa85f64-5717-4562-b3fc-2c963f66afa6'::uuid, 'a1b2c3d4-5678-90ab-cdef-1234567890ee'::uuid, '짭조름한 소스와 함께 즐기는 일본 전통 메밀국수', '자루 소바', '자루소바.jpg'),
    (true, 9000, now(), null, now(), 'f4d5e6b7-8c99-4a0d-bb11-2e3f456789aa'::uuid, null, 'f4d5e6b7-8c99-4a0d-bb11-2e3f456789aa'::uuid, '3fa85f64-5717-4562-b3fc-2c963f66afa6'::uuid, 'b7c8d9e0-1234-5678-90ab-cdef12345678'::uuid, '고소한 크림과 신선한 버섯이 어우러진 크림 파스타', '버섯 크림 파스타', 'mushroom_pasta.jpg'),
    (true, 13500, now(), null, now(), 'f4d5e6b7-8c99-4a0d-bb11-2e3f456789aa'::uuid, null, 'f4d5e6b7-8c99-4a0d-bb11-2e3f456789aa'::uuid, '3fa85f64-5717-4562-b3fc-2c963f66afa6'::uuid, 'c9d0e1f2-2345-6789-0abc-def123456789'::uuid, '매콤한 소스와 부드러운 치즈가 조화로운 한입 가득 라자냐', '스파이시 치즈 라자냐', 'spicy_lasagna.jpg'),
    (true, 15500, now(), null, now(), 'f4d5e6b7-8c99-4a0d-bb11-2e3f456789aa'::uuid, null, 'f4d5e6b7-8c99-4a0d-bb11-2e3f456789aa'::uuid, '3fa85f64-5717-4562-b3fc-2c963f66afa6'::uuid, 'd1e2f3a4-3456-7890-abcd-ef1234567890'::uuid, '달콤한 데리야끼 소스와 부드러운 닭고기가 어우러진 일본식 덮밥', '데리야끼 치킨 덮밥', 'teriyaki_chicken.jpg'),
